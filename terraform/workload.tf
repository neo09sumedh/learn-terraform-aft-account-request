...
module "bu-prod" { #Create a new module resource for every new account you want to provision ,You can  define module name as per your requirement
  ...
  control_tower_parameters = {
    ...
    AccountName               = "prodbutwo" # Account Name
    ...
    SSOUserEmail              = "asumedh+prodbutwo@amazon.com" #Account email must be unique and you should be able to verify through email id specfied
...
module "bu-dev" { #Create a new module resource for every new account you want to provision ,You can  define module name as per your requirement
  ...
  control_tower_parameters = {
    AccountEmail              = "asumedh+devtwo@amazon.com" #Account email must be unique and you should be able to verify account through email, Usage :- user+accountname@domain
    AccountName               = "devtwo" # Account Name
    ...
    SSOUserEmail              = "asumedh+devtwo@amazon.com" #Account email must be unique and you should be able to verify through email id specfied
    SSOUserFirstName          = "sumedh" #You can specify user first name
    SSOUserLastName           = "Ambapkar" #You can specify user last name
  }
